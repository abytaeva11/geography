...
function TestPages6() {
    const question1 = '8 Төрөөлүнүн деңгээли кандай социалдык-экономикалык факторлорго жараша болот?';
        ...
        <div className="test-page">
            <div className="test-page-inside">
                ...
                <Question
                    ...
                    onAnswerSelected={handleAnswerSelected}
                />
                <h1>Тема: 4. Калктын курамы жана эмгек ресурстары</h1>
                <Question
                    question={question4}
                    options={options4}
